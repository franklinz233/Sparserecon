...
from sparserecon.cam_utils import orbit_camera, mat2latlon, find_mask_center_and_translate
from sparserecon.render_utils.gs_renderer import CustomCamera
from sparserecon.mesh_utils.mesh_renderer import Renderer


class MeshRefinementStage:
...
def run_from_options(opt):
    stage = MeshRefinementStage(opt)
    stage.run(opt.iters_refine)
